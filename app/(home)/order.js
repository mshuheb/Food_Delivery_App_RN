...
import { Video } from "expo-av";
  ...
  const order = () => {
    ...
    const videoUri = require("../../assets/Food Delivery.mp4"); // Path to your local video
    ...
    return (
      <SafeAreaView>
        ...
        <Video
          source={videoUri} // Reference to the local video file
          style={{ width: "100%", height: 400 }}
          isLooping // Enable looping
          resizeMode="contain" // Ensure the video fits the container
